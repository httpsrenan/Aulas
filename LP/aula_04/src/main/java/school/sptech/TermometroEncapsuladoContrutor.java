...
public class TermometroEncapsuladoContrutor {
...
//    - Construtor:
//
//    - Construtor Vazio (O Java cria assim de baixo dos panos):
//    public TermometroEncapsuladoContrutor() {
//
//    }

//    - Construtor Cheio:
    public TermometroEncapsuladoContrutor(Double temperaturaAtual,
                                          Double temperaturaMaxRegistrada,
                                          Double temperaturaMinRegistrada) {
